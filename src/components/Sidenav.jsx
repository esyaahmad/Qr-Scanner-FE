  ...
  return (
    <>
      {open ? (
        <aside
          id="default-sidebar"
          className="bg-gray-200 dark:bg-gray-800 top-0 left-0 z-40 w-44 h-full transition-transform -translate-x-full translate-x-0"
          // className="fixed bg-gray-200 dark:bg-gray-800 top-0 left-0 z-40 w-44 h-screen transition-transform -translate-x-full xl:translate-x-0"
        ...
        >
          ...
          {/* <img src="./src/assets/left-arrow.png" className="absolute ml-44 cursor-pointer rounded-full-right-3 top-9 w-7 border-2 border-dark-pruple" /> */}
